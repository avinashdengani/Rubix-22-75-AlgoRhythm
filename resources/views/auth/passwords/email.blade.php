...
@section('title', 'Forgot Password | Foodie')
        ...
        <div class="row justify-content-center ml-0 mr-0 pl-0 pr-0">
            <div class="col-md-12">
                <div class="card d-flex flex-row shadow p-4 justify-content-evenly">
                    <div class="d-flex flex-column justify-content-center login-side-image">
                        <img src="{{ asset('images/auth/auth_img.jpg') }}" class="rounded shadow" alt="image" width="350px">
                    </div>
